<div class="content">
    ...
    <p>Ce tournoi organisé par <?php echo $association ?> est l'occasion pour
        tous les permanents du site de participer à une activité sportive
        conviviale permettant de mieux se connaître. La pétanque, née à La
        Ciotat, se prête bien à cela !</p>
    <?php if ($etat == 'ZZZ'): ?>
        <h2>Zzzzzz....</h2>
